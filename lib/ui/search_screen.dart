...
/// Simple letter avatar widget replacing the abandoned avatar_abc package
class _LetterAvatar extends StatelessWidget {
  final String title;

  const _LetterAvatar({required this.title});
...
class _SearchScreenBloc {
  ...
  var _pageNum = 0;
  final StreamController<ApiResponse<List<HitModel>>> _hitsListController =
      StreamController<ApiResponse<List<HitModel>>>();

  final StreamController<LoadStatus> _hitsLoadStatusController =
